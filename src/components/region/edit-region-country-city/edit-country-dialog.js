...
export default function EditCountryDialog(props) {
    ...
    return (
        <div>
            <Tooltip title="Edit Country" onClick={handleEditCountry}>
                <IconButton>
                    <EditOutlinedIcon fontSize="big" />
                </IconButton>
            </Tooltip>
            <Dialog open={open} onClose={handleClose}>
                <DialogTitle>Edit the name of the country </DialogTitle>
                <DialogContent>
                    <TextField
                        autoFocus
                        margin="dense"
